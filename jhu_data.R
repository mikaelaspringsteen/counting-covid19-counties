...
coronanet$type[coronanet$type == "Anti-Disinformation Measures"] <- "Anti-disinformation measures"
coronanet$type[coronanet$type == "New Task Force, Bureau or Administrative Configuration"] <- "New task force"
coronanet$type[coronanet$type == "Public Awareness Measures"] <- "Public awareness measures"
